...
| `src/data/` | Browser-API, Finance-Provider, Laufzeitmodus und IndexedDB-Finance-Cache |
...
| `api/_lib/` | Konfiguration, HTTP, Security, Google-Identität, gemeinsamer PostgreSQL-Pool, Finance-Repository und Operator-Import |
| `migrations/` | transaktionale PostgreSQL-Migrationen für das ownergebundene Finance-v1-Schema |
| `scripts/` | Node-ESM-, Browser-, Offline- und Service-Worker-Smokes, Operator-Import und Docs-Check |
