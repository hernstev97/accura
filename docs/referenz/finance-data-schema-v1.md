...
Nach dem Cutover aus [ADR 0013](../entscheidungen/0013-postgresql-als-finanzquelle.md) ist dieser Vertrag das einmalige Importformat. Der normalisierte `FinanceDataV1`-Vertrag wird produktiv aus PostgreSQL gelesen.
