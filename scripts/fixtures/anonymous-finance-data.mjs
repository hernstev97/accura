export const anonymousFinanceData = {
  ...
  debts: [
    { id: 'dkb', name: 'DKB', kind: 'loan', monthlyPaymentCents: 22022, displayOrder: 1, active: true, note: 'Raw English DKB spreadsheet note', dueDay: 20 },
    { id: 'coolblue', name: 'Coolblue', kind: 'installment', monthlyPaymentCents: 16400, displayOrder: 2, active: true, note: 'Letzte Rate im September 2026', dueDay: null },
    { id: 'fabfilter', name: 'Fabfilter', kind: 'installment', monthlyPaymentCents: 3870, displayOrder: 3, active: true, note: 'Software-Finanzierung', dueDay: null },
    { id: 'straight-outta-cotton', name: 'Straight Outta Cotton', kind: 'installment', monthlyPaymentCents: 1838, displayOrder: 4, active: true, note: 'Ratenkauf', dueDay: null },
    { id: 'soulframe', name: 'Soulframe', kind: 'installment', monthlyPaymentCents: 500, displayOrder: 5, active: true, note: 'Ratenkauf', dueDay: null },
  ],
  debtSnapshots: [
